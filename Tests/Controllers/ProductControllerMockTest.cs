...
public class ProductControllerMockTest
{
    ...
    public void ShouldGetProduct()
    {
        ...
        Assert.AreEqual(_mapper.Map<ProduitDetailDto>(produitInDb), returnProduct);
    }
    ...
    public void ShouldGetAllProducts()
    {
        ...
        Assert.IsTrue(_mapper.Map<IEnumerable<ProduitDto>>(productInDb).SequenceEqual(products.Value));
